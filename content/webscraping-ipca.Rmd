...
- eu utilizo a operação `.[[6]]` após selecionar a tabela, porque? O `html_nodes` retorna uma lista e tenho que extrair o sexto elemento da lista para trabalhar com ele.
