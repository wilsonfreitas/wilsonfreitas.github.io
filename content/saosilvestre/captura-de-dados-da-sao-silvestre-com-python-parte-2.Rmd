...
Agora vou mostrar como o arquivo CSV foi utilizado, como os dados foram limpos e como foi feita a análise quantitativa para tentar responder a pergunta.
...
O conteúdo das páginas não é confiável e vê-se que é manual e sem verificações.
No entanto, este é o trabalho de quem tem que garimpar dados na Internet, é necessário criar formas de verificação das hipóteses.
